    ...
    <div class="md-layout-item md-size-33 md-small-size-50 md-xsmall-size-80 ">
        <md-card>
            ...
            <md-card-header class="md-primary">
                <div class="md-title">Create your Devspace account:</div>
            </md-card-header>
            ...
            <md-card-actions>
                <div class="md-layout md-alignment-center-center">
                    <div class="md-layout-item md-size-100 md-layout md-alignment-center-left">
                        <md-button :disabled="creating || $v.$invalid" @click="submit" class="md-raised md-primary">Sign up</md-button>
                    </div>
                    <br><br><br>
...
export default {
    ...
    computed: mapGetters(['creating', 'error']),
    watch: {
        error(value){
